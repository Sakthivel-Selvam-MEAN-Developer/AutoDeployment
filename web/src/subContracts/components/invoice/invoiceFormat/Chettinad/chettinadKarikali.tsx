...
const Chettinad_Karikkali: FC<InvoiceProps> = ({ tripId, company, lastBillNumber }) => {
    console.log(company)
    ...
    return (
        <section className="chettinad-section" id="chettinad-section">
            <main className="chettinad-main bt bb bl br df-fc">
                ...
                <div className="df">
                    <div className="billing-address bb br df-fc">
                        ...
                        <div>
                            ...
                            <div>
                                <h3 className="pl pb">GSTIN: 33AAACC3130A1ZQ, PAN :AAACC3130A</h3>
                            </div>
                        </div>
                    </div>
                ...
                <div className="amount df bb">
                    <div className="description-of-service">
                        ...
                        <div className="df br" style={{ height: '100px' }}>
                            ...
                            <div className="df-fc pt pb jsp">
                                <div>
                                    <h4 className="ta p-2">Transportation charges for DEPOTS</h4>
                    ...
                    <div className="df">
                        ...
                        <div className="df-fc jsp">
                            ...
                            <h3 style={{ height: '29px', width: '200px' }} className="te p-2 bt">
                                {total.totalAmount}
                            </h3>
                        </div>
                    </div>
                ...
                <div className="bt pt pb pl pr">
                    <p>
                        ...
                        supplied by us during the financial year {financialYear} .under the forward
                        charge.
                    </p>
                </div>
                <div className="bt pt pb pl pr">
