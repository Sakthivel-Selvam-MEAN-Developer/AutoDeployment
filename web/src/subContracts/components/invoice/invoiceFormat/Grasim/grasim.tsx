...
const Grasim: React.FC<InvoiceProps> = ({ tripId, setLoading, loading }) => {
                ...
                <main className="main" id="ultratech_main">
                    ...
                    <div className="address">
                        <div className="customer">
                            <div>
                                <h4>M/s Grasim Industries Limited</h4>
                                <h4>
                                    Unit:- B2B Ecommerce, 8th Floor, Umiya Business Bay,
                                    <br />
                                    Cessna Business Park, Marathahali, Sarjapur
                                    <br />
                                    Outer Ring Road, Bangalore
                                </h4>
                                <h4>Place of Supply: KARNATAKA, 560103</h4>
                            </div>
