...
export const GetCells: FC<GetCellsProps> = ({ trip, trips, index, id, setTripDetails }) => {
    return (
        <>
            <TableCell align="left">1</TableCell>
            <TableCell align="left">{trips[index]?.truck.vehicleNumber}</TableCell>
            ...
            <TableCell align="left">{trips[index]?.truck.transporter.csmName}</TableCell>
