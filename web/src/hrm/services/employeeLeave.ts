...
export const getAllLeaveAfterApply = (data: any) => axiosInstance.get('/leaves', data).then(getData)

export const getAllLeaveWithStatus = (data: any) => axiosInstance.get('/status', data).then(getData)
